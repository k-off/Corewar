...
/*                                                   +#+                      */
/*   Created: 2019/08/22 14:03:19 by lskrauci      #+#    #+#                 */
/*   Updated: 2019/08/22 14:03:20 by lskrauci      ########   odam.nl         */
/*                                                                            */
/* ************************************************************************** */
...
** @desc then it performs bitwise and operation on
...
** @param int num1 - number 1 for bitwise and operation
** @param int num2 - number 2 for bitwise and operation
** @param int reg - destination register
** @return void
*/

void	carriage_and(t_carriage *carriage, int num1, int num2, int reg)
{
