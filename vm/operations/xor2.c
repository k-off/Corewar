...
/*                                                   +#+                      */
/*   Created: 2019/08/22 14:43:31 by lskrauci      #+#    #+#                 */
/*   Updated: 2019/08/22 14:43:33 by lskrauci      ########   odam.nl         */
/*                                                                            */
/* ************************************************************************** */
...
** @desc then it performs bitwise xor operation on
...
** @param int num1 - number 1 for bitwise xor operation
** @param int num2 - number 2 for bitwise xor operation
** @param int reg - destination register
** @return void
*/

void	carriage_xor(t_carriage *carriage, int num1, int num2, int reg)
{
